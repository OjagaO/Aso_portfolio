                                ...
                                <div class="modal-info">
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            ...
                                            CSSでのハンバーガーメニューにてこずりレスポンシブに10時間程度。<br></br>
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            ...
                                            ・レスポンシブがどのサイズでも崩れがないようにした点<br></br>
                                            ・初めてスマホサイズから制作<br></br>
                                    ...
                                    <dl>
                                        <dt>◆コンセプト</dt>
                                        <dd>
                                            実際に使われているWEBページはカラーにまとまりが無く、
                                            ページ内リンクなどがなく欲しい情報に適宜移ることが出来ない
                                            というのが気になった点であり、主な連絡手段が電話であると言うふうに
                                            感じ取れたのでスマホサイズでは直接電話につながるような設計にし、パソコンサイズでは
                                            直接電話をかける人はほとんどいないだろうということで電話番号のみの表記にしております。
                                            <br></br><br></br>
                                            全体的なコンセプトとしては青を基調として自分が実際に職業訓練校に通おう。
                                            と思った際にわからなくて困ったことなどを解消できるように致しました。
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt>◆改善点</dt>
                                        <dd>
                                            ...
                                            ・写真の素材がなかなか集まらずに統一感がなく伝えたい情報にマッチしない写真を使っている。<br></br>
                                            ・開講中のクラスに関する情報をリアルタイムで更新できる機能をつけたかった<br></br>
                                    ...
                                    <dl>
                                        <dt>◆苦労した点</dt>
                                        <dd>
                                            ・通い始めて１ヶ月の時期に制作を始めたこともあり
                                            HTML,CSS,JQueryの基礎的な部分もおろそかな状態で
                                            制作に取り掛かった為一つ一つ調べながらでとても時間がかかった点<br></br><br></br>
                                            ・最初にデザインを決める段階でこんなにデザインを考えるのが大変なのかと痛感させられ
                                            結局いろんなサイトから参考にしたりしながらオリジナリティーのあるモノにできなかった点<br></br><br></br>
                                            ・あまり理解度の高くないものをカスタマイズしようとした時に崩れがどこが原因で起きているのかが
                                            なかなかわからずにすごい時間を費やしてしまった点<br></br><br></br>
                                            ・CSSのみでハンバーガーとアコーディオンを実装しようと思ったときに
                                            HTML側の構造に制限が付きまとってしまいなかなか思い通りのデザインや
                                            動きを実装できなかった点<br></br><br></br>
                                            ・レスポンシブというものがそもそも中々理解が足りてなく
                                            シンプルにレスポンシブに苦労致しました
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt>◆制作を通してのコメント</dt>
                                        <dd>
                                            HTML,CSSへの理解が深まりJQueryというものの概要をつかむ機会となりました。
                                            日頃見るハンバーガーメニューやアコーディオンメニュー等、
                                            動きのある機能を実装できた時は感動しました。
                                            リッチな動きなどはまだ実装できませんでしたが
                                            今後リッチな動きを実装できるようになりたいと思わされました。
                                        </dd>
                                    </dl>
                                </div>
                            </div>
                            ...
                            <div class="modal-box">
                                ...
                                <div class="modal-info">
                                    ...
                                    <dl>
                                        <dt>◆コンセプト</dt>
                                        <dd>
                                            本猫カフェは猫の可愛さや癒しというのをテーマに制作いたしました。
                                            そのサービスやコンテンツに適した写真の素材や、
                                            色使いというのを心がけてコーディングを行いました。
                                            <br></br><br></br>
                                            全体的なコンセプトとしては淡い雰囲気を基調として、
                                            日ごろの仕事に疲れや不満があり猫に癒しを求める女性の方をターゲットとしました。
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt>◆改善点</dt>
                                        <dd>
                                            ・background-imageとimgタグで出来ることがアバウトだったのでそこを整理しなおしてコーディングしたい。<br></br>
                                            ・positionを多用してしまったことにより強引にデザインを整えたが故にレスポンシブにとても苦労した点<br></br>
                                            ・お店のこだわりなど強みをもう少し押し出したページにしたかった<br></br>
                                    ...
                                    <dl>
                                        <dt>◆苦労した点</dt>
                                        <dd>
                                            ・中々思い通りのデザインにならず、強引に整えるためにpositionの多用の結果
                                            高さが浮いてしまったり、レスポンシブの際に崩れがひどかったりとpositionはできる限り使わず、
                                            特定のコンテンツの中で整えるために正しく使おうと思いました。<br></br><br></br>
                                            ・画像のサイズなどがなかなか合わずに思い通りのデザインにならなかった点<br></br><br></br>
                                            ・淡い雰囲気にするために疑似要素で全体的に淡くしたのですが
                                            その弊害でaタグが機能しなくなったりはっきりさせたい部分も淡くなってしまった点
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt>◆制作を通してのコメント</dt>
                                        <dd>
                                            HTML,CSSへの理解が深まりJQueryを一から書いてみる機会となりました。
                                            全体的に雰囲気を統一して複数ページを作るという経験は初めてでしたので
                                            出来上がった時の達成感がありました。
                            ...
                            <div class="modal-box">
                                ...
                                <div class="modal-info">
                                    ...
                                    <dl>
                                        <dt>◆コンセプト</dt>
                                        <dd>
                                            本IT系サイトは先進的なイメージというのをテーマに制作いたしました。
                                            普通の企業だと鬱陶しく感じられるマウスストーカーなどや、
                                            particleなどによる動きを取り入れました。
                                            <br></br><br></br>
                                            全体的なコンセプトとしてはグラデーションを用いた配色を基調として、
                                            その分他の場所はシンプルにしております。
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt>◆改善点</dt>
                                        <dd>
                                            ・indexのページのマウスストーカーの動きが重くなってしまった点。<br></br>
                                            ・トップページのファーストインパクトが弱くなってしまった点<br></br>
                                            ・求人の部分などはさらに細かくして新卒、キャリア等更に下層ページまで作成したかった<br></br>
                                    ...
                                    <dl>
                                        <dt>◆苦労した点</dt>
                                        <dd>
                                            ・様々なプラグインを取り入れたことにより動作が重くなってしまい、
                                            その原因を特定して改善しようとコード事態や順番を見直したりした点<br></br><br></br>
                                    ...
                                    <dl>
                                        <dt>◆制作を通してのコメント</dt>
                                        <dd>
                                            プラグインやライブラリといったものを積極的に使うをコンセプトに制作したので、
                                            slick,particleを使いJSでマウスストーカーを実装出来たことに喜びや楽しさを感じました。
                                ...
                                <div class="modal-info">
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            ...
                                            ・timeタグのdatetime,itempropなどを用いてSEOを意識したコーディング<br></br>
                                    ...
                                    <dl>
                                        <dt>◆コンセプト</dt>
                                        <dd>
                                            本美容系サイトは清潔感と高級感を意識して作成しました。
                                            高級感を出しすぎないように、スタッフの人柄の良さや体験談などを交えたページです。

                                            <br></br><br></br>
                                            全体的なコンセプトとしては白を基調にグレーと黒のシックなサイトに仕上げました。
                                            高級感と誠実さが感じられやすいようにそのような配色にしました。
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt>◆改善点</dt>
                                        <dd>
                                            ・女性をターゲットにしているのでもう少し色味のあるサイトが良かったのではないか<br></br>
                                            ・画像等に妥協してしまったので当初のイメージとは異なってしまった点<br></br>
                                            ・BLOGのエリアはSEOの観点から取り入れたが、もう少し作りこめたなという点<br></br>
                                            ・後半のデザインの物足りなさ。<br></br>
                                            ・日付選択画面のユーザビリティーをもう少し高めたかった点<br></br>
                                    ...
                                    <dl>
                                        <dt>◆苦労した点</dt>
                                        <dd>
                                            ・SVGを用いたリッチな動きを実装するにあたり外から取り入れたものと
                                            自分が一から書いているものがなかなか繋がらずに手こずった点<br></br><br></br>
                                            ・下スクロール時にヘッダーが現れる動きを実装したのだが1pxでも上にあがると
                                            消えてしまい動きの激しいUIになってしまうのでそこのバッファを持たせた点
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt>◆制作を通してのコメント</dt>
                                        <dd>
                                            今回は新しい技術というよりも既存の技術で素早く制作するという目標で制作をはじめ、
                                            もう少し早く終われると思っていたのですが素材探し等に時間を思ったよりもとられてしまい
                            ...
                            <div class="modal-box">
                                ...
                                <div class="modal-info">
                                    ...
                                    <dl>
                                        <dt>◆改善点</dt>
                                        <dd>
                                            ・書き込んだタスクをローカルストレージに保存できるようにしたかった点<br></br>
                                    ...
                                    <dl>
                                        <dt>◆苦労した点</dt>
                                        <dd>
                                            ・スタートがReactの知識が0、JSの知識が未熟な状態だった点<br></br>
                                    ...
                                    <dl>
                                        <dt>◆制作を通してのコメント</dt>
                                        <dd>
                                            結果的にhooksやprops。コンポーネント単位で制作ができ管理がしやすい等の
                                            Reactの利点を一部ながら体感することができた。スタートする前に聞いたHTMLとJSが混ざったような記述
                            ...
                            <div class="modal-box">
                                ...
                                <div class="modal-info">
                                    ...
                                    <dl>
                                        <dt>◆改善点</dt>
                                        <dd>
                                            ・スクロールに合わせてもっと動きを追加すればよかった点<br></br>
                                            ・PC１ページに時間をかけすぎた点
                                        </dd>
                                    </dl>
                                    <dl>
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            ...
                                            疑似要素でデザイン的な部分を書くという経験があまり無かった為
                                            とても練習になった。
                                        </dd>
                                    </dl>
                                </div>
                            ...
                            <div class="modal-box">
                                ...
                                <div class="modal-info">
                                    ...
                                    <dl>
                                        <dt>◆苦労した点</dt>
                                        <dd>
                                            ・不足分の素材を自前で調達や、画像サイズがバラバラであったためトリミングが必要だった点
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt>◆制作を通してのコメント</dt>
                                        <dd>
                                            コーディングの面で苦労することはあまりなかったが、
                                            画像素材の調達や、画像のサイズ等現場に出ても起こりえることだと思い、
                                            対処することができた。
                                        </dd>
                                    </dl>
                                </div>
                                ...
                                <div class="modal-info">
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            ...
                                            ・jQueryを用いたサイドヘッダーの動きの処理がうまくいかなかった点<br></br>
                                    ...
                                    <dl>
                                        <dt>◆苦労した点</dt>
                                        <dd>
                                            ・positionで浮いた高さをjQueryで取得した高さを与えて解決した点
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt>◆制作を通してのコメント</dt>
                                        <dd>
                                            上記にもある通りpositionで浮いてしまった要素に高さを用いた動きを実装したいが高さがないため
                                            綺麗に実装できずに苦労したが、別の要素から高さを取得して与えることで解決ができたので、
                            ...
                            <div class="modal-box">
                                ...
                                <div class="modal-info">
                                    ...
                                    <dl>
                                        <dt>◆改善点</dt>
                                        <dd>
                                            ・カンプ上の文字数とレイアウト的に実現不可能なデザインに遭遇した際に、
                                            レイアウトをコチラで少しいじってしまった点。
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt>◆苦労した点</dt>
                                        <dd>
                                            ・上記にもある通り、カンプ上の例文と実際の文字数の差異により
                                            文字数とレイアウト的に実現不可能なデザインに遭遇した点
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt>◆制作を通してのコメント</dt>
                                        <dd>
                                            jQuery等のプラグインを複数用いて 上記の課題を解決することができたのはよかったが
                                            実際の現場ではそれがクライアントの希望と異なる可能性も考慮すると、
                                            様々な切り口の解決策を持っておきたいと思いました。
                                        </dd>
                                    </dl>
                                </div>
                            </div>
                                ...
                                <div class="modal-info">
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            ...
                                            参考動画を視聴しつつJQuery,Ajaxを調べながら2時間程度。<br></br>
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            ...
                                            ・取得したデータをそのまま出力するのではなく、見る人が見やすいようにreplace等で整えた点<br></br>
                                    ...
                                    <dl>
                                        <dt>◆コンセプト</dt>
                                        <dd>
                                            以前から天気を使ったアプリケーションを作ってみたいという思いがあった為、
                                            それと並行してターゲットを自分とした場合の制作になりました。
                                            <br></br><br></br>
                                            降水確率と風速等に左右される体感温度あたりが自分としては欲しい情報だったので
                                            それを盛り込んだ天気アプリとなっております。
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt>◆改善点</dt>
                                        <dd>
                                            ・条件分岐などで降水確率の特定のラインをを使用者が指定出来てそのラインを超えると通知がいって傘を忘れないように通知する機能等を盛り込みたかった<br></br>
                                            ・上にも書いたことだが情報の押し付けのような側面が多いため、アクションに対するレスポンスを返すような動きを実装したかった<br></br>
                                    ...
                                    <dl>
                                        <dt>◆苦労した点</dt>
                                        <dd>
                                            ・いくつか独自の関数を書いていたのですが、その中で吐き出されるバグや
                                            少しだけ思い通りにいかない等の修正。<br></br><br></br>
                                            ・for文の動作が思った通りに行かなくて、色々試した結果正しく動かせるようになったが
                                            原因があまり正確に把握できていない点<br></br><br></br>
                                    ...
                                    <dl>
                                        <dt>◆制作を通してのコメント</dt>
                                        <dd>
                                            JSを用いてAPIのkeyや、ajaxに関して学ぶことができた。
                                            自分でほしい情報などをいじれたり、JSを一から書いて関数を作ったりと自分のスキル外のことを模索しながら
                                            失敗したり成功したりと楽しい時間だった。
                                        </dd>
                                    </dl>
                                </div>
                            ...
                            <div class="modal-box">
                                ...
                                <div class="modal-info">
                                    ...
                                    <dl>
                                        <dt>◆こだわり</dt>
                                        <dd>
                                            ・既存サイトのニュース欄を投稿に合わせて更新されるようにした点<br></br>
                                            ・アイキャッチ画像がそのまま投稿ページのサムネイルになるように設定した点<br></br>
                                            ・共通化が最初うまくいかなかったが最終的にget_template_partでうまくいくようにした点<br></br>
                                            ・固定ページごとにスラッグを指定してpage-$slug.phpで対応した点<br></br>
                                    ...
                                    <dl>
                                        <dt>◆改善点・苦労した点</dt>
                                        <dd>
                                            ・WPのテンプレートタグで出力されるHTMLが少し変わっていてレイアウトが崩れたりということもあったので随時検証機能などを用いて確認するべきだった点<br></br>
                                            ・既存のサイトをそのまま置き換えただけでプラグインなどを使って利便性を上げることができなかった点<br></br>
                                    ...
                                    <dl>
                                        <dt>◆制作を通してのコメント</dt>
                                        <dd>
                                            既存のサイトをWordpress化することでWordpress独自のPHPの理解が深まり、
                                            既存のテーマなどをいじる際にもとても活きそうだと感じた。
                            ...
                            <div class="modal-box">
                                ...
                                <div class="modal-info">
                                    ...
                                    <dl>
                                        <dt>◆こだわり</dt>
                                        <dd>
                                            ・チェックボックスで完了と削除を管理できるようにした点<br></br>
                                            ・タスクの追加をEnterキーと＋ボタンのどちらでも追加できるようにした点<br></br>
                                            ・細かく条件分岐しアラートで状況喚起を行うようにした点<br></br>
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt>◆改善点・苦労した点</dt>
                                        <dd>
                                            ・1から自分でJavaScriptを書くのが初めてだった為、メソッド(？)が思った通りの結果を出してくれず自分のまだ学べていないメソッドでしか解決できなかった点<br></br>
                                            ・foreach文の中のfor文の中の挙動がうまくいかずアプローチ自体を大幅に変えて解決した点<br></br>
                                            ・ローカルストレージとのやり取りがコンソールログを細かく確認しないと全然動かなかった点<br></br>
                                            ・DOMの取得が配列で行われるものなのかオブジェクトで取得できているのか等がごちゃごちゃで、メソッドが仕事したりしなかったりした点<br></br>
                                            ・ローカルストレージに保存した情報を更新時に画面上に正しく表示するのに苦労した点<br></br>
                                    ...
                                    <dl>
                                        <dt>◆制作を通してのコメント</dt>
                                        <dd>
                                            今までJavaScriptは動画等を見ながらなぞらえて作っていただけだったのですが、
                                            過去に動画を見ながらReactで作ったTodoリストをバニラのJSで１から自分で書き直してみようということで、
                            ...
                            <div class="modal-box">
                                ...
                                <div class="modal-info">
                                    ...
                                    <dl>
                                        <dt>◆こだわり</dt>
                                        <dd>
                                            ・送信ボタンとエンターキーのどちらでも送信できるようにした点<br></br>
                                    ...
                                    <dl>
                                        <dt>◆改善点・苦労した点</dt>
                                        <dd>
                                            ・チャットボット側がメッセージを送っているときは利用者側の送信ボタンを機能しないようにしたかったがうまくできなかった点<br></br>
                                            ・スマホで確認した時にメッセージの入力欄が隠れてしまったので100vhではなくてJSで値を取得して解決した点<br></br>
                                            ・一つ目の改善点に付随したものになるがボット側が送っている途中や想定外のアクションが行われた際に想定通りの挙動ができない点<br></br>
                                            ・preventDefaultがないと無駄なというか指定していない動きなども含まれていることを知らずに時間をかけてしまった点<br></br>
                                            ・初めて引数を二つ用いた点
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt>◆制作を通してのコメント</dt>
                                        <dd>
                                            JavaScriptのメソッド等をしっかりと学ぶ前に実際にアプリケーションを作っていると
                                            自分のその時持っている知識だったらこう解決できそうだなと思ってやってみてうまくいかないなと思い、調べてみると
                                            意外と簡単に別のメッソドで解決出来たりしたので実際に作ることと並行して、
                                            様々なメソッドに限らず知識を学びたいなと思いました。
