            ...
            <div className="work-box">
              ...
              <ul className="line delayScroll">
                <li className="work-item">
                  <p
                    id="demo01"
                    className="work-item_p"
                    onClick={() => openFunc("animatedModal1")}
                  >
                    <img
                      src="images/scshot-kita.png"
                ...
                <li className="work-item">
                  <p
                    id="demo02"
                    className="work-item_p"
                    onClick={() => openFunc("animatedModal2")}
                  >
                    <img

                      src="./images/scshot-cat2.png"
                      alt="thumbnail of site"
                    ></img>
                    <span className="work-item-sentence">
                      |猫カフェ～ごろごろ～|
              ...
              <ul className="line delayScroll">
                <li className=" work-item">
                  <p
                    id="demo03"
                    className="work-item_p"
                    onClick={() => openFunc("animatedModal3")}
                  >
                    <img

                      src="./images/diz-screenshot.png"
                      alt="thumbnail of site"
                    ></img>
                    <span className="work-item-sentence">
                      |　株式会社 Diz　|
                ...
                <li className=" work-item">
                  <p
                    id="demo04"
                    className="work-item_p"
                    onClick={() => openFunc("animatedModal4")}
                  >
                    <img

                      src="./images/sizingHunter.png"
                      alt="thumbnail of site"
                    ></img>
                    <span className="work-item-sentence">
                      |　　Hunter.　　|
              ...
              <ul className="line delayScroll">
                <li className=" work-item">
                  <p
                    id="demo09"
                    className="work-item_p"
                    onClick={() => openFunc("animatedModal9")}
                  >
                    <img

                      src="./images/Csalon.top.png"
                      alt="thumbnail of site"
                    ></img>
                    <span className="work-item-sentence">
                      |　north C east　|
                ...
                <li className=" work-item">
                  <p
                    id="demo06"
                    className="work-item_p"
                    onClick={() => openFunc("animatedModal6")}
                  >
                    <img

                      src="./images/kitasalon.top.png"
                      alt=""
                    ></img>
                    <span className="work-item-sentence">
                      |　NORTH C EAST　|
              ...
              <ul className="line delayScroll">
                <li className=" work-item">
                  <p
                    id="demo07"
                    className="work-item_p"
                    onClick={() => openFunc("animatedModal7")}
                  >
                    <img

                      src="./images/kitakanndou.top.png"
                      alt="thumbnail of site"
                    ></img>
                ...
                <li className=" work-item">
                  <p
                    id="demo08"
                    className="work-item_p"
                    onClick={() => openFunc("animatedModal8")}
                  >
                    <img

                      src="./images/shrine.top.png"
                      alt=""
                    ></img>
                    <span className="work-item-sentence">
                      |　　北関神社　　|
              ...
              <ul className="line delayScroll">
                <li className=" work-item">
                  <p
                    id="demo05"
                    className="work-item_p"
                    onClick={() => openFunc("animatedModal5")}
                  >
                    <img

                      src="./images/resize-todo.png"
                      alt="thumbnail of site"
                    ></img>
                    <span className="work-item-sentence">
                      |　　Todo List　　|
              ...
              <ul className="line delayScroll">
                <li className=" work-item">
                  <p
                    id="demo12"
                    className="work-item_p"
                    onClick={() => openFunc("animatedModal12")}
                  >
                    <img
                ...
                <li className=" work-item">
                  <p
                    id="demo13"
                    className="work-item_p"
                    onClick={() => openFunc("animatedModal13")}
                  >
                    <img
              ...
              <ul className="line delayScroll">
                <li className=" work-item">
                  <p
                    id="demo11"
                    className="work-item_p"
                    onClick={() => openFunc("animatedModal11")}
                  >
                    <img
                ...
                <li className=" work-item">
                  <p
                    id="demo14"
                    className="work-item_p"
                    onClick={() => openFunc("animatedModal14")}
                  >
                    <img src="" alt=""></img>
              ...
              <div className="modal-box">
                <div className="modal-title">
                  <h2>
                    北関東学院<br></br>
                    <a
                      href="https://ojagao.github.io/kitakanto/"
                ...
                <div className="modal-info">
                  ...
                  <dl>
                    ...
                    <dd>
                      ...
                      制作に取り掛かった為一つ一つ調べながらでとても時間がかかった点
                      <br></br>
                      <br></br>
                      ・最初にデザインを決める段階でこんなにデザインを考えるのが大変なのかと痛感させられ
                      結局いろんなサイトから参考にしたりしながらオリジナリティーのあるモノにできなかった点
                      <br></br>
                      <br></br>
                      ・あまり理解度の高くないものをカスタマイズしようとした時に崩れがどこが原因で起きているのかが
                      なかなかわからずにすごい時間を費やしてしまった点<br></br>
                      <br></br>
            ...
            <div className="modal-content">
              <div className="modal-box">
                <div className="modal-title">
                  <h2>
                    猫カフェ～ごろごろ～<br></br>
                    <a href="https://ojagao.github.io/catcafe/" >
                      実際のサイトはこちら→
                    </a>
                  </h2>
                </div>
                <div className="modal-info">
                  <dl>
                    <dt>◆作品概要</dt>
                    <dd>
                      職業訓練校に通い初めて１ヶ月半程経った時期に自主的に作成した
                      猫カフェの架空サイトになります。
                    </dd>
                  </dl>
                  <dl>
            ...
            <div className="modal-content">
              <div className="modal-box">
                <div className="modal-title">
                  <h2>
                    株式会社 Diz<br></br>
                    <a href="https://ojagao.github.io/Diz/" >
                      実際のサイトはこちら→
                    </a>
                  </h2>
                </div>
                <div className="modal-info">
                  ...
                  <dl>
                    ...
                    <dd>
                      ...
                      その原因を特定して改善しようとコード事態や順番を見直したりした点
                      <br></br>
                      <br></br>
              ...
              <div className="modal-img">
                <img
                  ...
                  src="./images/screencapture-ojagao-github-io-Diz-2022-11-07-15_30_23.png"
                  alt=""
                ></img>
              </div>
            </div>
            ...
            <div className="modal-content">
              <div className="modal-box">
                <div className="modal-title">
                  <h2>
                    Hunter.<br></br>
                    <a href="https://ojagao.github.io/Hunter/" >
                      実際のサイトはこちら→
                    </a>
                  </h2>
                </div>
                <div className="modal-info">
                  <dl>
                    <dt>◆作品概要</dt>
                    <dd>
                      職業訓練校に通い初めて2ヶ月経った時期に作成した
                      美容サロンの架空サイト( LP )になります。
                    </dd>
                  </dl>
                  <dl>
                    <dt>◆制作時間</dt>
              ...
              <div className="modal-img">
                <img
                  ...
                  src="./images/screenshot-beautysalon.jpeg"
                  alt=""
                ></img>
              </div>
            </div>
              ...
              <div className="modal-box">
                <div className="modal-title">
                  <h2>
                    Todo List<br></br>
                    <a
                      href="https://ojagao.github.io/TodoReact/"
              ...
              <div className="modal-box">
                <div className="modal-title">
                  <h2>
                    NORTH C EAST<br></br>
                    <a
                      href="https://ojagao.github.io/kitasalon/"
                ...
                <div className="modal-info">
                  <dl>
                    <dt>◆作品概要</dt>
                    <dd>
                      職業訓練校に通い初めて3ヶ月通った時期に他クラスの要望により作成した
                      PCサイズのみのサイトになります。
                    </dd>
                  </dl>
                  <dl>
            ...
            <div className="modal-content">
              <div className="modal-box">
                <div className="modal-title">
                  <h2>
                    北関堂<br></br>
                    <a href="https://ojagao.github.io/wagashi/" >
                      実際のサイトはこちら→
                    </a>
                  </h2>
                </div>
            ...
            <div className="modal-content">
              <div className="modal-box">
                <div className="modal-title">
                  <h2>
                    北関神社<br></br>
                    <a href="https://ojagao.github.io/shrine/" >
                      実際のサイトはこちら→
                    </a>
                  </h2>
                </div>
              ...
              <div className="modal-img">
                <img
                  ...
                  src="./images/screencapture-ojagao-github-io-shrine-2022-12-07-11_40_08.png"
                  alt=""
                ></img>
              </div>
            </div>
              ...
              <div className="modal-box">
                <div className="modal-title">
                  <h2>
                    north C east<br></br>
                    <a
                      href="https://ojagao.github.io/kitasalon2/"
              ...
              <div className="modal-box">
                <div className="modal-title">
                  <h2>
                    ...
                    <a href="https://ojagao.github.io/weather/" >
                      実際のサイトはこちら→
                    </a>
                  </h2>
                </div>
                <div className="modal-info">
                  <dl>
                    <dt>◆作品概要</dt>
                    <dd>
                      職業訓練校に通い初めて3ヶ月半程経った時期に自主的に作成した
                      天気アプリになります。
                    </dd>
                  </dl>
                  <dl>
                  ...
                  <dl>
                    ...
                    <dd>
                      ...
                      少しだけ思い通りにいかない等の修正。<br></br>
                      <br></br>
                      ・for文の動作が思った通りに行かなくて、色々試した結果正しく動かせるようになったが
                      原因があまり正確に把握できていない点<br></br>
                      <br></br>
              ...
              <div className="modal-box">
                <div className="modal-title">
                  <h2>
                    ...
                    <a href="http://program21.wp.xdomain.jp/" >
                      実際のサイトはこちら→
                    </a>
                  </h2>
                </div>
                <div className="modal-info">
                  <dl>
                    <dt>◆作品概要</dt>
                    <dd>
                      職業訓練校に通い初めて3ヶ月程経った時期にWordpress化した
                      過去に作った架空サイトになります。
                    </dd>
                  </dl>
                  <dl>
              ...
              <div className="modal-box">
                <div className="modal-title">
                  <h2>
                    ...
                    <a
                      href="https://ojagao.github.io/vanillaTodo/"
            ...
            <div className="modal-content">
              <div className="modal-box">
                <div className="modal-title">
                  <h2>
                    chat BOT<br></br>
                    <a href="https://ojagao.github.io/chatbot/" >
                      実際のサイトはこちら→
                    </a>
                  </h2>
                </div>
